		...
		<ul class="slider">
							...
							<div class="col-md-8 header-w3right"> 
								...
								<div class="profile-agileinfo"> 
									...
									<div class="col-md-4 col-xs-4 profile-grids"> 
										...
										<ul class="address"> 
											<li> 
												<b>Fecha de Nacimiento</b> : 13-08-2000 
											</li>
											<li> 
												<b>Titulo Profesional</b> : Diseñador Web
											</li>
											<li> 
												<b>HOBBIES</b> : Escribir y resolver puzzles
											</li> 
										</ul>
									</div>
									<div class="col-md-4 col-xs-4 profile-grids"> 
										...
										<ul class="address"> 
											<li> 
												<b>Télefono</b> : +57 300 360 1364
											</li> 
											<li> 
												<b>FAX</b> :  +15 555 5678
											</li> 
											<li> 
												<b>Dirección</b> : Medellín, Colombia. 
											</li>
										</ul>
									</div>
									<div class="col-md-4 col-xs-4 profile-grids"> 
										...
										<ul class="address"> 
											<li> 
												<b>Correo Electrónico</b> : <a href="mailto:yohan.gil@kodigofuente.com"> yohan.gil@kodigofuente.com</a>
											</li>
											<li> 
												<b>Sitio Web</b> : <a href= <?= base_url()?>>www.miresumen.com</a>
											</li>
										</ul>
									</div>
						...
						<div class="col-md-12 skills-w3lsleft">
							...
							<div class="skill-agileinfo">
								...
								<div class="skillbar" data-percent="70">
									<span class="skillbar-title" style="background: #46465e;">CodeIgniter</span>
									<p class="skillbar-bar" style="background: #db5866;"></p>
									<span class="skill-bar-percent"></span>
								</div>
								<!-- End Skill Bar --> 
							</div>
				...
				<div class="work agileits-w3layouts">
					<div class="container">  
						<div class="col-md-6 work-agile-left">
							<h3 class="agileits-title">Experiencia Laboral</h3> 
									...
									<div class="panel-heading" role="tab" id="headingTwo">
										<h4 class="panel-title asd">
											<a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
												<span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i> 2018-2021
											</a>
										</h4>
									</div>
									<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
										<div class="panel-body panel_text">
											<h5>Supermercados La Pastora </h5>
											Me especialice en la labor de servicio al cliente, siendo el cajero del supermercado, y siendo asesor de compras
											de compras para algunos clientes, fui encargado de compras de una sección en especifico, y en este lugar 
											desarrolle el trabajo en equipo ya que era un grupo grande de empleados.
										</div>
									</div>
								</div>
								<div class="panel panel-default">
							...
							<h3 class="agileits-title agileits-title2">Estudios</h3> 
							<div class="panel-group w3l_panel_group_faq" role="tablist" id="accordion1">
								<div class="panel panel-default">
									<div class="panel-heading" role="tab" id="headingfive">
										<h4 class="panel-title asd">
											<a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
												<span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>Bachiller
											</a>
										</h4>
									</div>
									<div id="collapsefive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingfive">
										<div class="panel-body panel_text">
											<h5>La Salle</h5>
											Tuve la oportunidad de participar en equipos de desarrollo mientras cursaba el último año,
											aprendiendo cosas básicas del manejo de lenguajes de programación y algoritmos. 
										</div>
									</div>
								</div> 
							</div> 
						...
						<div class="col-md-6 work-agile-right"> 
							<h3 class="agileits-title">Proyectos</h3> 
							<!-- Projects -->
							<div class="Projects">  
								<div class="col-md-6 col-sm-6 col-xs-6 agileits-img"> 
									<a href="https://sapiuat.kodigofuente.com/" target="_blank">
										<img class="img-responsive " src="images/g1.png" alt="SAPI"  /> 
			...
			<li class="agileits"> 
				...
				<div class="contact agileits-w3layouts">
					<div class="container"> 
						<h3 class="agileits-title">Contactame</h3> 	
						<div class="contact-w3lsrow">
							<div class="col-md-6 contact-wthree-right">
								<form action="#" method="post">
									...
									<input type="text" class="phone" name="phone" placeholder="Telefono" required="">
